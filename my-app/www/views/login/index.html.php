    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-8 text-center">
                ...
                <p class="text-indigo-100 mt-2">Acceder à votre espace personnel</p>
            </div>
            <form class="p-6 space-y-6" method="post" action="/login">
                ...
                <div class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg font-semibold shadow-lg hover:shadow-xl duration-200 transition-all transform hover:-translate-y-0.5">
                    <button type="submit">Se connecter</button>
                </div>

                <div class="text-center pt-4 border_t border-gray-200">
                    <p class="text-sm text-gray-600">Pas encore de compte ?<a class="font-semibold text-indigo-600 hover:text-indigo-700 transition-colors" href="/register"> S'inscrire</a></p>
                </div>
            </form>
        </div>
    </div>
