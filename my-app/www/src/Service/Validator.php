...
class Validator
{
    ...
    public function validateEmail(string $email, string $fieldName = 'email'): bool
    {
        ...
        // La colonne email est VARCHAR(255), donc max 255 caractères
        if (!$this->coreValidator->max($email, 255)) {
     ...
     * @return bool True si valide, false sinon
     */
    public function validateTitle(string $title, string $fieldName = 'title', int $maxLength = 500): bool
    {
